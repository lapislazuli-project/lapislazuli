...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the lapislazuli unit tests or QA tests
...
[Translation Process](https://github.com/forking-altcoins/lapislazuli/blob/master/doc/translation_process.md)
