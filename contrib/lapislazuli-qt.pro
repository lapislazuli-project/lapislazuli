...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/lapislazuli-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/lapislazuli-cli.cpp \
           src/lapislazuli-tx.cpp \
           src/lapislazuli.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/lapislazuli.qrc src/qt/lapislazuli_locale.qrc

TRANSLATIONS += src/qt/locale/lapislazuli_bg.ts \
                src/qt/locale/lapislazuli_de.ts \
                src/qt/locale/lapislazuli_en.ts \
                src/qt/locale/lapislazuli_es.ts \
                src/qt/locale/lapislazuli_fi.ts \
                src/qt/locale/lapislazuli_fr.ts \
                src/qt/locale/lapislazuli_it.ts \
                src/qt/locale/lapislazuli_ja.ts \
                src/qt/locale/lapislazuli_pl.ts \
                src/qt/locale/lapislazuli_pt.ts \
                src/qt/locale/lapislazuli_ru.ts \
                src/qt/locale/lapislazuli_sk.ts \
                src/qt/locale/lapislazuli_sv.ts \
                src/qt/locale/lapislazuli_vi.ts \
                src/qt/locale/lapislazuli_zh_CN.ts \
                src/qt/locale/lapislazuli_zh_TW.ts
