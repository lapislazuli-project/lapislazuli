...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "lapislazuli" is a composite category enabling all Lapislazuli-related debug output
            if (ptrCategory->count(std::string("lapislazuli"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "lapislazuli.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "lapislazulid.pid"));
