...
// Copyright (c) 2015-2019 The Lapislazuli developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000380fb4661482d1f003b5ecbefe58aed6a5a15f256e78414e480428fbe58"));  //launch
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1652947200, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("046be0fe2389c302a1649ba54eb6c72053042f1955f8a61d393c2059430a33156dd73abe5e26c52c3d1cd25a373fcc9388ceebbcb0e308eeb2212298cefe665b6d");
        nDefaultPort = 19330;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Lapislazuli starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nLapislazuliBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nLapislazuliBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1652947200; //!> Sporks signed after Monday, August 26, 2019 11:00:00 PM GMT must use the new spork key
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Thu May 19 2022 08:00:00 GMT+0000 - start blockchain LiLLi.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0490ab18ef9b989a32245a3886871d49f8f64a607bd3e22041ea50390102da4efc29303bb4d89a6e8c0276cf2df053f03fb475f274f10d85e972a0820dcce53fa6") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1652947200;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xb3c3e0ecc95b30dab19a1260838798bc6b9edfca3c213efcf63ead77f8f6e847"));

		vFixedSeeds.clear();
		vSeeds.clear();

        vSeeds.push_back(CDNSSeedData("45.8.248.102", "45.8.248.102"));
        vSeeds.push_back(CDNSSeedData("66.135.1.17", "66.135.1.17"));
        vSeeds.push_back(CDNSSeedData("80.249.151.204", "80.249.151.204"));
        vSeeds.push_back(CDNSSeedData("79.143.31.111", "79.143.31.111"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zLiLLi to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04a42483f1bfd3e7fda4a70f7e1ad023611884b94df11ceef9519cf7db9701361afc5de073773f392a0d3872c1490922d0474e65af572b09cced98a579ff389be4");
        nDefaultPort = 19340;
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nLapislazuliBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nLapislazuliBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48); // Testnet lapislazuli addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet lapislazuli script addresses start with 'w'
        ...
        strObfuscationPoolDummyAddress = "LW5mnPduovqtohyQXYmcVwA7LH2TRSaCh5";
        nStartMasternodePayments = 1652947200; //Fri, 09 Jan 2015 21:05:58 GMT
