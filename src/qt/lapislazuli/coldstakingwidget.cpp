...
#include "qt/lapislazuli/coldstakingwidget.h"
#include "qt/lapislazuli/forms/ui_coldstakingwidget.h"
#include "qt/lapislazuli/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/lapislazuli/requestdialog.h"
#include "qt/lapislazuli/tooltipmenu.h"
#include "qt/lapislazuli/furlistrow.h"
...
#include "qt/lapislazuli/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(LapislazuliGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your LiLLis, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept LiLLi delegation / Delegate LiLLi"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select LiLLi outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 LiLLi" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
