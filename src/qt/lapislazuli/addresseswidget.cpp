...
#include "qt/lapislazuli/forms/ui_addresseswidget.h"
#include "qt/lapislazuli/addresslabelrow.h"
#include "qt/lapislazuli/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(LapislazuliGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Lapislazuli address"));
