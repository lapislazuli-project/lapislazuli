...
#include "qt/lapislazuli/forms/ui_receivewidget.h"
...
#include "qt/lapislazuli/addressholder.h"
...
ReceiveWidget::ReceiveWidget(LapislazuliGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive LiLLi."));
