...
#include "qt/lapislazuli/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(LapislazuliGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-lapislazuli");
