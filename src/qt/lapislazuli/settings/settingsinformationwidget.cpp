...
#include "qt/lapislazuli/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(LapislazuliGUI* _window,QWidget *parent) :
