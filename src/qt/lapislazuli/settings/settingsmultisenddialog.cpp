...
#include "qt/lapislazuli/settings/settingsmultisenddialog.h"
#include "qt/lapislazuli/settings/forms/ui_settingsmultisenddialog.h"
#include <QListView>
    ...
    ui(new Ui::SettingsMultisendDialog)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText("Lapislazuli address or contact label");
