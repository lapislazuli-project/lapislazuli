...
#include "qt/lapislazuli/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/lapislazuli/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(LapislazuliGUI* _window, QWidget *parent) :
