...
#include "qt/lapislazuli/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(LapislazuliGUI* _window, QWidget *parent) :
