...
#include "qt/lapislazuli/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/lapislazuli/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(LapislazuliGUI* _window, QWidget *parent) :
