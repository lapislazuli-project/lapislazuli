...
#include "qt/lapislazuli/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/lapislazuli/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(LapislazuliGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to LapislazuliGUI::handleRestart()
