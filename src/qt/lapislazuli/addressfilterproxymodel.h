...
#ifndef Lapislazuli_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Lapislazuli_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Lapislazuli_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
