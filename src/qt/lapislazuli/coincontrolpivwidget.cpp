...
#include "qt/lapislazuli/coincontrolpivwidget.h"
#include "qt/lapislazuli/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select LiLLi Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("LiLLi");
    ...
    ui->labelValueAfter->setText("0.00 LiLLi");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 LiLLi");
    ui->labelValueFee->setText("0.00 LiLLi");
