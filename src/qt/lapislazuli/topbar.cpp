...
#include "qt/lapislazuli/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/lapislazuli/lockunlock.h"
#include "qt/lapislazuli/qtutils.h"
#include "qt/lapislazuli/receivedialog.h"
...
TopBar::TopBar(LapislazuliGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Lapislazuli")
    updateDisplayUnit();
