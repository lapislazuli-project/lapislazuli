...
#include "qt/lapislazuli/furabstractlistitemdelegate.h"
#include "qt/lapislazuli/txviewholder.h"
#include "qt/lapislazuli/tooltipmenu.h"
#include "qt/lapislazuli/sendmultirow.h"
#include "qt/lapislazuli/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(LapislazuliGUI* parent);
    ~ColdStakingWidget();
