// Copyright (c) 2017-2020 The Lapislazuli developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "zLiLLicontroldialog.h"
#include "ui_zLiLLicontroldialog.h"
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zLiLLi Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zLiLLi.";
            else if (!mint.isSeedCorrect)
                strReason = "The zLiLLi seed used to mint this zLiLLi is not the same as currently hold in the wallet";
            else
