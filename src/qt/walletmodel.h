...
#ifndef Lapislazuli_QT_WALLETMODEL_H
#define Lapislazuli_QT_WALLETMODEL_H
...
/** Interface to Lapislazuli wallet from Qt view code. */
...
#endif // Lapislazuli_QT_WALLETMODEL_H
