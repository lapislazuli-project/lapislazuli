...
#include "qt/lapislazuli/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR LiLLi</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                LapislazuliGUI* window = static_cast<LapislazuliGUI*>(parentWidget());
...
{
    LapislazuliGUI* gui = static_cast<LapislazuliGUI*>(parentWidget());
...
{
    hide();
    static_cast<LapislazuliGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
