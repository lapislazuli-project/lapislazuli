                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLiLLiPathCustom = GetArg("-zLiLLibackuppath", "");
    ...
    if(!strzLiLLiPathCustom.empty()) {
        ui->wallet_customzLiLLibackuppath->setText(QString::fromStdString(strzLiLLiPathCustom));
        ui->wallet_customzLiLLibackuppath_label->setVisible(true);
        ui->wallet_customzLiLLibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLiLLiPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Lapislazuli RPC console.") + "<br>" +
