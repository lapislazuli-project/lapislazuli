...
// Copyright (c) 2016-2020 The Lapislazuli developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("LiLLi Stake");
    case TransactionRecord::StakeZLiLLi:
        return tr("zLiLLi Stake");
    case TransactionRecord::StakeDelegated:
        return tr("LiLLi Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("LiLLi Stake on behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted LiLLi to zLiLLi");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zLiLLi");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received LiLLi from zLiLLi");
    case TransactionRecord::ZerocoinSpend_Change_zPiv:
        return tr("Minted Change as zLiLLi from zLiLLi Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zLiLLi to LiLLi");
    default:
        return QString();
    }
}
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZLiLLi || rec->type == TransactionRecord::MNReward) {
