/* src/config/lapislazuli-config.h.  Generated from lapislazuli-config.h.in by configure.  */
/* src/config/lapislazuli-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LiLLi_CONFIG_H

#define LiLLi_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/forking-altcoins/lapislazuli/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lapislazuli Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lapislazuli Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lapislazuli"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://lapislazuli.org/"
