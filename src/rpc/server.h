...
/**
 * Lapislazuli RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzLiLLiseed(const UniValue& params, bool fHelp);
extern UniValue getzLiLLiseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzLiLLi(const UniValue& params, bool fHelp);
extern UniValue dzLiLListate(const UniValue& params, bool fHelp);
