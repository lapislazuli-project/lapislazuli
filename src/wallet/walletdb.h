...
public:
    ...
    bool WriteZLiLLiSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZLiLLiSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZLiLLiSeed_deprecated(uint256& seed);
    bool EraseZLiLLiSeed();
    bool EraseZLiLLiSeed_deprecated();

    bool WriteZLiLLiCount(const uint32_t& nCount);
    bool ReadZLiLLiCount(uint32_t& nCount);
