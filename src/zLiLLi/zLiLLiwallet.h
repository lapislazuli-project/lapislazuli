// Copyright (c) 2017-2018 The Lapislazuli developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Lapislazuli_ZLiLLiWALLET_H
#define Lapislazuli_ZLiLLiWALLET_H
...
public:
    CzLiLLiWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLiLLi(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLiLLi(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //Lapislazuli_ZLiLLiWALLET_H
