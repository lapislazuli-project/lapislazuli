...
#ifndef Lapislazuli_ZLiLLiTRACKER_H
#define Lapislazuli_ZLiLLiTRACKER_H
...
public:
    CzLiLLiTracker(std::string strWalletFile);
    ~CzLiLLiTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLiLLiWallet* zLiLLiWallet = NULL);
...
#endif //Lapislazuli_ZLiLLiTRACKER_H
