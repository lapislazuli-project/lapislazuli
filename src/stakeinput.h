...
#ifndef Lapislazuli_STAKEINPUT_H
#define Lapislazuli_STAKEINPUT_H
...
// zLiLLiStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zLiLLi, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZLiLLi() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZLiLLi() override { return false; }
...
#endif //Lapislazuli_STAKEINPUT_H
