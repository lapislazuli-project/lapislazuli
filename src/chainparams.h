...
public:
    ...
    int LapislazuliBadBlockTime() const { return nLapislazuliBadBlockTime; }
    int LapislazuliBadBlocknBits() const { return nLapislazuliBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nLapislazuliBadBlockTime;
    unsigned int nLapislazuliBadBlocknBits;
