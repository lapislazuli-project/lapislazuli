...
class RawTransactionsTest(LapislazuliTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid lapislazuli address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid lapislazuli address" in e.error['message'])
