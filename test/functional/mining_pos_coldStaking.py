...
from test_framework.lapislazuli_node import LapislazuliTestNode
...
class Lapislazuli_ColdStakingTest(LapislazuliTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(LapislazuliTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 LiLLi from the pot)
...
if __name__ == '__main__':
    Lapislazuli_ColdStakingTest().main()
